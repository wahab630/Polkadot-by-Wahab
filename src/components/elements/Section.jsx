          ...
          <div className="row justify-content-center mb-4">
            <div className="col-12 col-md-6 col-lg-4 mb-4">
              <div className="text-center text-md-left">
                ...
                />
                <div>
                  <h5 className="h5 mb-2 mt-2 font-weight-bold text-center text-md-left">
                    True interoperability
                  </h5>
                  <p className="text-center text-md-left pr-md-2">
            ...
            <div className="col-12 col-md-6 col-lg-4 mb-4">
              <div className="text-center text-md-left">
                ...
                />
                <div>
                  <h5 className="h5 mb-2 mt-2 fw-bold text-center text-md-left">
              ...
              <div className="text-center text-md-left">
                ...
                <div>
                  ...
                  <p className="text-center text-md-left pr-md-2">
                    ...
                    <a
                      href="https://www.carbon-ratings.com/dl/pos-report-2022"
                      target="_blank"
                      rel="nofollow noopener noreferrer"
                      className="text-underline"
                    >
