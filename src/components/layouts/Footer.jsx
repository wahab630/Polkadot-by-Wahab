          ...
          <div className="row">
            <div className="col-6 col-md-4 col-lg-3 mb-3 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li className="py-0 py-md-1">
                  <a href="/launch-roadmap" className="">
                    Roadmap
                  </a>
                </li>
                <li className="py-0 py-md-1">
            ...
            <div className="col-6 col-md-4 col-lg-3 mb-3 mb-md-0">
              ...
              <ul className="list-unstyled">
                ...
                <li className="py-0 py-md-1">
                  <a href="/cross-chain-communication" className="">
                    XCM
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/parachains" className="">
                    Parachains
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/dot-token" className="">
                    Token
                  </a>
                </li>
                <li className="py-0 py-md-1">
            ...
            <div className="col-12 col-md-4 col-lg-2 col-xl-3 mb-3 mb-md-4 mb-lg-0">
              ...
              <ul className="list-unstyled">
                <li className="py-0 py-md-1">
                  <a href="/community" className="c">
                    Community
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/academy" className="c">
                    Academy
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/auctions" className="c">
                    Auctions
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/treasury" className="c">
                    Treasury
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="https://wiki.polkadot.network" className="c">
                    Documentation
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/blog" className="c">
                    Blog
                  </a>
                </li>
                <li className="py-0 py-md-1">
                  <a href="/brand-assets" className="c">
                    Brand Assets
                  </a>
                </li>
                <li className="py-0 py-md-1">
            ...
            <div className="col-12 col-lg-3 px-lg-0 mt-4 mt-lg-0">
              <ul className="list-social-links list-unstyled justify-content-start justify-content-lg-between mb-4 mb-md-5 mb-lg-4 mb-xl-3 d-flex">
                ...
                <li>
                  <FaYoutube className="footer-icon" size={30} />{" "}
                </li>
                <li>
                  <FaDiscord size={30} />
                </li>
              ...
              <button
                className="btn footer-btn rounded-pill fw-bold d-block mb-1"
              ...
              <ul className="list-unstyled d-flex flex-wrap ">
                <li>
                  <span className="small  me-1">
                    ©
                    <a href="https://web3.foundation" className="">
                      2022 Web3 Foundation
                    </a>{" "}
                  </span>{" "}
                </li>
                <li>
                  <a href="/impressum" className="c small  me-1 ">
                    {" "}
                    | Impressum{" "}
                  </a>{" "}
                </li>
                <li>
                  <a href="/disclaimer" className="c small me-1">
                    {" "}
                    | Disclaimer
                  </a>{" "}
                </li>
                <li>
                  <a href="/privacy" className="c small">
                    {" "}
                    | Privacy
                  </a>
                </li>
